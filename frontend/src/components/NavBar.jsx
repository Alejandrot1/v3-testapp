...
const navClasses = ({ isActive }) => 
  `px-3 py-2 rounded-md text-sm font-medium ${isActive ? 'bg-fire-red text-white' : 'text-gray-700 hover:bg-gray-100'}`;
    ...
    <header className="bg-white border-b">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-fire-red text-white font-bold">FD</span>
          <div>
        ...
        <nav className="flex items-center gap-2">
          ...
          <NavLink to="/firefighters" className={navClasses}>Firefighters</NavLink>
